...
const aside = document.getElementById("side-drawer");
const footer = document.getElementById("footer");
let cartElementIds = JSON.parse(localStorage.getItem("cartElementIds")) || [];
let nbCartItems = cartElementIds.length || 0;
header.innerHTML = `<div id="logo"><h2>Game Haven</h2></div>
<nav>
  <ul>
    <li class="hide-mobile"><a href="/www/index.html">Home</a></li>
    <li class="hide-mobile"><a href="/www/products.html">Products</a></li>
    <li class="hide-mobile">
      <a href="/www/contact.html">Contact Us</a>
    </li>
    <li class="hide-mobile"><a href="/www/aboutUs.html">About Us</a></li>
    <li>
      <a href="/www/cart.html" id="cart-container"
        >Cart
        <svg
          fill="none"
          stroke="currentColor"
...
<ul>
  ...
  <li><a href="/www/products.html">Products</a></li>
  <li>
    <a href="/www/contact.html">Contact Us</a>
  </li>
  <li><a href="/www/aboutUs.html">About Us</a></li>
</ul>
</nav>`;
...
<li>
<a href="https://github.com/Abd-404/CIS201/tree/main/Project" target="_blank">
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width="24"
    height="24"
